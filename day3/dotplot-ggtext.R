...
comp <- dates |>
    left_join(
        ...
        by = c(
            "sex",
            "birth_year_fix" = "year",
            "age_at_coronation" = "age"
        )
    ) |>
    mutate(cohort_ex = age_at_coronation + ex)
...
comp |>
    ...
    annotate(
        "text",
        x = c(65, 50),
        y = c("King Edward VIII", "King George VI"),
        label = c("Reference subjects", "Monarchs"),
        hjust = 1,
        size = 4,
        family = "Roboto Slab",
        color = c("#64B6EE", "#B5223B")
    )

ggsave(
    "out/royal-survival.png",
    width = 8,
    height = 4.5,
    type = "cairo-png",
    bg = "#ffffff"
...
ggsave(
    "out/royal-survival-relative.png",
    width = 8,
    height = 4.5,
    type = "cairo-png"
)
...
ggsave(
    "out/royal-survival-combined.png",
    width = 8,
    height = 4.5,
    type = "cairo-png"
)
