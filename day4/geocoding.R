...
# https://docs.google.com/spreadsheets/d/1mYysngSVU8QGGP9TJwgP_gy6zR2bV6Kae0Vch278cxY
...
raw <- gsheet2tbl("https://docs.google.com/spreadsheets/d/1mYysngSVU8QGGP9TJwgP_gy6zR2bV6Kae0Vch278cxY")
...
world_outline_robinson %>% 
    ...
    labs(
        ...
        subtitle = "Dataviz course at LCDS, September 2022",
        caption = "@ikashnitsky"
    )+
    theme(
